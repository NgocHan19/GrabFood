                ...
                <div className="detail_Orderfood col-md-5">
                    ...
                    <div className="add_option_order mt-4">
                        <h3 style={{fontSize:20}}>Thêm</h3>
                            ...
                            <label className='form-check-label' > Trà tắc <span>15.000</span></label><br/>
                            <input className='form-check-input' type="checkbox" name="tea" value="tea"/>
                            <label className='form-check-label'> Trà đào <span>20.000</span></label><br/>
                            <input className='form-check-input' type="checkbox" name="tea" value="tea"/>
                            <label className='form-check-label'> Sting <span>10.000</span></label><br/>
                            <input className='form-check-input' type="checkbox" name="tea" value="tea"/>
                            <label className='form-check-label'> Coca <span>12.000</span></label><br/>
                            </div>
                    </div>
